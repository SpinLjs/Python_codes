...
for i in range(0,n_it):
    ...
    Psi_inv2=(Psi_inv-k_n*(x_tmp.T*Psi_inv))/lambda_RLS;
    Psi_inv=Psi_inv2;
...
axarr[0].plot(10*np.log10(Es_sd/Ds_n));
axarr[0].set_title('Learning curve for SD')
axarr[0].set_ylabel('')
axarr[0].set_xlabel('')
axarr[0].grid()

axarr[1].plot(10*np.log10(Es_Newton/Ds_n))
...
axarr[0].plot(10*np.log10(Es_LMS/Ds_n));
axarr[0].set_title('Learning curve for LMS')
axarr[0].set_ylabel('')
axarr[0].set_xlabel('')
axarr[0].grid()

axarr[1].plot(10*np.log10(Es_NtLMS/Ds_n))
axarr[1].set_title('Learning curve for Newton LMS')
axarr[1].set_ylabel('')
axarr[1].set_xlabel('')
axarr[1].grid()

axarr[2].plot(10*np.log10(Es_NLMS/Ds_n))
...
fig, axarr = plt.subplots(2, sharex=False)
axarr[0].plot(10*np.log10(Es_AP/Ds_n));
axarr[0].set_title('Learning curve for AP')
axarr[0].set_ylabel('')
axarr[0].set_xlabel('')
axarr[0].grid()

axarr[1].plot(10*np.log10(Es_RLS/Ds_n))
...
#fig, axarr = plt.subplots(2, sharex=False)
#axarr[0].plot(Es_sd/Ds_n);
#axarr[0].set_title('Learning curve for SD')
#axarr[0].set_ylabel('')
#axarr[0].set_xlabel('')
#axarr[0].grid()
#
#axarr[1].plot(Es_Newton/Ds_n)
#axarr[1].set_title('Learning curve for Newton')
#axarr[1].set_ylabel('')
#axarr[1].set_xlabel('k')
#axarr[1].grid()
#
#fig, axarr = plt.subplots(3, sharex=False)
#axarr[0].plot(Es_LMS/Ds_n);
#axarr[0].set_title('Learning curve for LMS')
#axarr[0].set_ylabel('')
#axarr[0].set_xlabel('')
#axarr[0].grid()
#
#axarr[1].plot(Es_NtLMS/Ds_n)
#axarr[1].set_title('Learning curve for Newton LMS')
#axarr[1].set_ylabel('')
#axarr[1].set_xlabel('')
#axarr[1].grid()
#
#axarr[2].plot(Es_NLMS/Ds_n)
#axarr[2].set_title('Learning curve for NLMS')
#axarr[2].set_ylabel('')
#axarr[2].set_xlabel('k')
#axarr[2].grid()
#
#fig, axarr = plt.subplots(2, sharex=False)
#axarr[0].plot(Es_AP/Ds_n);
#axarr[0].set_title('Learning curve for AP')
#axarr[0].set_ylabel('')
#axarr[0].set_xlabel('')
#axarr[0].grid()
#
#axarr[1].plot(Es_RLS/Ds_n)
#axarr[1].set_title('Learning curve for Recursive LS')
#axarr[1].set_ylabel('')
#axarr[1].set_xlabel('k')
#axarr[1].grid()